...
"""autogenerated by genpy from ur5_vs/joint_angles.msg. Do not edit."""
import codecs
import sys
...
class joint_angles(genpy.Message):
  _md5sum = "64ff27ecf58f5c4afd7b139766a662b7"
  _type = "ur5_vs/joint_angles"
...
float64 data"""
  __slots__ = ['ang0','ang1','ang2','ang3','ang4','ang5']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6d().pack(_x.ang0.data, _x.ang1.data, _x.ang2.data, _x.ang3.data, _x.ang4.data, _x.ang5.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ang0.data, _x.ang1.data, _x.ang2.data, _x.ang3.data, _x.ang4.data, _x.ang5.data,) = _get_struct_6d().unpack(str[start:end])
      return self
