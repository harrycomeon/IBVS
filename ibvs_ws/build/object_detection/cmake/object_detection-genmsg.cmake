...
message(STATUS "object_detection: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iobject_detection:/home/harry/ibvs_ws/src/object_detection/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/harry/ibvs_ws/src/object_detection/msg/image_data.msg" NAME_WE)
add_custom_target(_object_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "object_detection" "/home/harry/ibvs_ws/src/object_detection/msg/image_data.msg" "std_msgs/Float64:std_msgs/Int64"
)
...
_generate_msg_cpp(object_detection
  "/home/harry/ibvs_ws/src/object_detection/msg/image_data.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/object_detection)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/object_detection\")")
  # install generated code
  install(
