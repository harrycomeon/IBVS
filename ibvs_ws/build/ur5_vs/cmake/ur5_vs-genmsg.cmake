...
message(STATUS "ur5_vs: 5 messages, 0 services")

set(MSG_I_FLAGS "-Iur5_vs:/home/harry/ibvs_ws/src/ur5_vs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/harry/ibvs_ws/src/ur5_vs/msg/sim_variables.msg" NAME_WE)
add_custom_target(_ur5_vs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_vs" "/home/harry/ibvs_ws/src/ur5_vs/msg/sim_variables.msg" "std_msgs/Bool"
)

get_filename_component(_filename "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_states.msg" NAME_WE)
add_custom_target(_ur5_vs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_vs" "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_states.msg" "std_msgs/Float64"
)

get_filename_component(_filename "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_vel.msg" NAME_WE)
add_custom_target(_ur5_vs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_vs" "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_vel.msg" "std_msgs/Float64"
)

get_filename_component(_filename "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_angles.msg" NAME_WE)
add_custom_target(_ur5_vs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_vs" "/home/harry/ibvs_ws/src/ur5_vs/msg/joint_angles.msg" "std_msgs/Float64"
)

get_filename_component(_filename "/home/harry/ibvs_ws/src/ur5_vs/msg/states.msg" NAME_WE)
add_custom_target(_ur5_vs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_vs" "/home/harry/ibvs_ws/src/ur5_vs/msg/states.msg" "std_msgs/Float64"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur5_vs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ur5_vs\")")
  # install generated code
  install(
