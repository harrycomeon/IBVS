...
//    URScript.data = "movej([5.379334449768066, -2.190873448048727, 1.505105972290039, -0.9141824881183069, -1.527306858693258, 2.2488760948181152],a=0.14,v=0.10)"; //new degreebend 2 yuan
...
//    u_d[0] = 320; u_d[1] = 240; //peg-in-hole
    ...
    u_d[0] = 320; u_d[1] = 235; //peg-in-hole
...
//    double centroid_depth_desired = 0.35;
//    double centroid_depth_desired = 0.35;
    double centroid_depth_desired = 0.45;
    ...
    f4.open("/home/harry/catkin_ws/src/ur5_vs/src/results/camera_vel.txt",std::ios_base::trunc);
...
//        if (sqrt_mean_error <= 13)  //success1,success2
//          if (sqrt_mean_error <= 0.0001)
//            break;

//        if (sqrt_mean_error <= 30)
