...
//    URScript.data = "movej([2.3473551273345947,-2.044220272694723,1.744307041168213,5.070453643798828,4.712550163269043,  3.136826276779175],a=0.24,v=0.10)"; //new degreebend 2
      ...
      URScript.data = "movej([3.1935062408447266,-1.8552196661578577,1.892092227935791,4.69989538192749,4.701924800872803,  4.791538715362549],a=0.24,v=0.10)"; //new degreebend 2
...
//    depth_p[0]=0.8, depth_p[1]=0.8;
    ...
    double centroid_depth_desired = 0.37;
    double m_d[3]={0,0,0};
